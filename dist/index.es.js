...
function serialize(editor, doc, options) {
    ...
    const glossary = Glossary.isGlossary(doc.content[doc.content.length - 1])
        ? content.pop()
        : null;
    const document = render(jsxs("document", Object.assign({ xmlns: CNXML_NAMESPACE, "cnxml-version": doc.version, id: doc.moduleId, "module-id": doc.moduleId, xmlLang: doc.language, class: (_a = doc.classes) === null || _a === void 0 ? void 0 : _a.join(' ') }, { children: [jsx("title", { children: doc.title }, void 0),
            jsx("content", { children: content }, void 0), glossary] })));
    if (format === 'dom') {
        return document;
    }
