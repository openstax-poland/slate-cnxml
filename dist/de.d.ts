 ...
 */
export declare function buildElement(editor: DeserializingEditor, el: Element, at: Path, template: Partial<Slate.Element>, context: Deserializers, withChildren?: boolean): void;
/**
...
export declare function normalizeMixed(editor: DeserializingEditor, at: Path): void;
