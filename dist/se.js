...
// full license text.
import { Admonition, AltText, Audio, Caption, Code, Commentary, CrossReference, Definition, DefinitionExample, DefinitionTerm, DocumentReference, Equation, Exercise, Figure, Footnote, Foreign, Glossary, Image, Link, List, ListItem, Meaning, Media, Paragraph, Preformat, Problem, ProcessingInstruction, Proof, Quotation, Rule, RuleExample, Section, SeeAlso, Solution, Statement, Term, Title, Video, WithClasses, } from 'cnx-designer';
...
const SERIALIZERS = [
    ...
    [Equation.isEquation, makeSerializer('equation')],
